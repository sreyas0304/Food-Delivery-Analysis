...
checkpointLocation = "s3://kinesis-stream-checkpointing/kinesisToRedshift/"
redshiftJdbcUrl = f"jdbc:redshift://redshift-cluster-1.cfifqxbmlmw0.us-east-1.redshift.amazonaws.com:5439/dev"
redshiftTable = "food_delivery_datamart.factOrders"
tempDir = "s3://redshift-temp-data-gds/temp_data/streaming_temp/"
